  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-2 w-full" id='home'>
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati nobis quas ratione, delectus consectetur doloremque saepe unde repudiandae rerum ullam a earum reprehenderit! Ut, perferendis enim exercitationem est possimus velit.</p>
